...
let userElixir = 0;
let missionElixir = 0;
const maxElixirContainer = 500000;
const maxTotalElixir = 1000000;

const questions = [
    { question: "Melyik karakter a Brawl Stars-ban képes gyógyítani a csapattársait?", answer: "Poco", reward: 490000 },
    { question: "Melyik Brawl Stars karakter használja a 'Bear Paws' támadást?", answer: "Nita", reward: 100000 },
    { question: "Melyik évben jelent meg a Brawl Stars?", answer: "2018", reward: 3000 },
    { question: "Melyik Brawl Stars karakter használja a 'Rocket Rain' támadást?", answer: "Brock", reward: 4000 },
    { question: "Melyik Brawl Stars karakternek van egy 'Super Totem' nevű gadgetje?", answer: "Bo", reward: 2000 }
];
...
function submitAnswer() {
    ...
    if (userAnswer === question.answer) {
        missionElixir += question.reward;
        document.getElementById('mission-elixir').innerText = missionElixir;
        document.getElementById('mission-container').style.display = 'block';
        document.getElementById('result').innerText = `Helyes válasz! Jutalmad: ${question.reward} elixír. Nyomd meg az "Elixír begyűjtése" gombot a jutalom begyűjtéséhez.`;
    } else {
...
function collectElixir() {
    let potentialElixir = userElixir + missionElixir;
    if (potentialElixir > maxElixirContainer) {
        userElixir = potentialElixir;
        document.getElementById('elixir-count').innerText = userElixir;
        document.getElementById('result').innerText = `Elixír begyűjtve! Jelenlegi elixír: ${userElixir}`;
